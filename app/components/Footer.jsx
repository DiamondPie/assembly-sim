...
export default function Footer() {
  return (<>
    <div className='flex justify-center pt-4 pb-2 items-center text-gray-500'>
    ...
    <div className='flex justify-center pb-4 h-12 items-center text-gray-500'>
      ...
      <div className="relative w-32 h-full ml-1">
        <Link 
          href="https://dpp.qzz.io" 
          target="_blank" 
          rel="noopener noreferrer"
          className="relative block h-full w-full hover:scale-95 duration-300 ease-in-out"
        >
          <Image 
            src={logo} 
            alt="Logo" 
      ...
      <Link 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        className="hover:text-(--text-secondary) duration-300"
      >
